  ...
  return (
    <>
        ...
        <div className="home-animate-on-scroll animate-on-scroll container mx-auto px-4">
          <div className="max-w-5xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/25 bg-primary/10 px-4 py-2 text-sm font-semibold text-primary">
              <span className="h-2.5 w-2.5 animate-pulse rounded-full bg-primary shadow-[0_0_0_4px_hsl(var(--primary)/.12)]" aria-hidden="true" />
              Who Are We?
            </div>
            ...
            <div className="mt-9 grid max-w-4xl gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {["Technology for Good", "Community First", "Sustainable Future", "Empowering Changemakers"].map((value) => (
                <div key={value} className="inline-flex items-center gap-2 rounded-full border border-primary/25 bg-primary/10 px-4 py-2 text-sm font-semibold text-primary">
                  <span className="h-2.5 w-2.5 shrink-0 animate-pulse rounded-full bg-primary shadow-[0_0_0_4px_hsl(var(--primary)/.12)]" aria-hidden="true" />
                  {value}
                </div>
              ))}
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          {eventsLoading ? (
            <div className="grid gap-6 md:grid-cols-3" aria-label="Loading events">
              {[0, 1, 2].map((item) => <div key={item} className="animate-pulse overflow-hidden rounded-2xl border bg-card shadow-lg"><div className="aspect-video bg-muted" /><div className="space-y-3 p-5"><div className="h-4 w-28 rounded bg-muted" /><div className="h-6 w-4/5 rounded bg-muted" /><div className="h-4 w-2/3 rounded bg-muted" /></div></div>)}
            </div>
          ) : latestEvents.length ? (
          ...
          ) : <div className="rounded-2xl border border-dashed bg-muted/30 p-10 text-center text-muted-foreground">Upcoming event details will appear here once published.</div>}
        </div>
      </section>
      ...
      {(awards.length > 0 || news.length > 0) && <section className="border-t bg-muted/30 py-16">
        <div className="home-animate-on-scroll animate-on-scroll container mx-auto grid gap-10 px-4 lg:grid-cols-2">
